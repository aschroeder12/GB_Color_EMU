 ...
 * MSB is R1, LSB is R2!
 */
void LOAD_REGISTER_RR_NN(unsigned char *, unsigned char *);
 ...
 */
void POP_RR(unsigned char *, unsigned char *);

/* PUSH RR - PUSH TO STACK
 * Push to the stack memory, data from the 16-bit register RR
 */
void PUSH_RR(unsigned char *, unsigned char *);
